...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG", "Manifest", "README.rdoc", "Rakefile", "github.rb", "init.rb", "lib/object_factory.rb", "spec/object_spec.rb", "spec/spec.opts", "tasks/rspec.rake", "object-factory.gemspec"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rujitsu>, [">= 0"])
    else
      s.add_dependency(%q<rujitsu>, [">= 0"])
    end
  else
    s.add_dependency(%q<rujitsu>, [">= 0"])
  end
